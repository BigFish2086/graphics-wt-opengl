...
// A forward declaration of the Entity Class
class Entity; 
...
class Component {
    // A pointer to the entity that owns this component
    Entity *owner;

    // The entity is a friend since it is the only one allowed to set itself as an owner of a certain component.
    friend Entity;
