...
// This is different from more complex renderers that could draw intermediate data to a framebuffer before computing the
// final color In this project, we only need to implement a forward renderer
class ForwardRenderer {
    ...
    // We define them here (instead of being local to the "render" function) as an optimization to prevent reallocating
    // them every frame
